...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, RCD_TEST_Pin|GPIO0_Pin|GPIO4_Pin|GPIO3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, FRAM_CS_Pin|DISPLAY_RESET_LED3_Pin|DISPLAY_CS_LED1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SLEEP_GPIO_Port, SLEEP_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, METER_CS_Pin|GPIO1_Pin|LOCK_F_Pin|LOCK_R_Pin
                          |CP_ENABLE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DISPLAY_DC_LED2_GPIO_Port, DISPLAY_DC_LED2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : RCD_TEST_Pin GPIO0_Pin GPIO4_Pin GPIO3_Pin */
  GPIO_InitStruct.Pin = RCD_TEST_Pin|GPIO0_Pin|GPIO4_Pin|GPIO3_Pin;
  ...
  /*Configure GPIO pins : FRAM_CS_Pin SLEEP_Pin */
  GPIO_InitStruct.Pin = FRAM_CS_Pin|SLEEP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);

  /*Configure GPIO pin : METER_CS_Pin */
  GPIO_InitStruct.Pin = METER_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(METER_CS_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : DISPLAY_DC_LED2_Pin */
  GPIO_InitStruct.Pin = DISPLAY_DC_LED2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DISPLAY_DC_LED2_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : DISPLAY_RESET_LED3_Pin DISPLAY_CS_LED1_Pin */
  GPIO_InitStruct.Pin = DISPLAY_RESET_LED3_Pin|DISPLAY_CS_LED1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);
